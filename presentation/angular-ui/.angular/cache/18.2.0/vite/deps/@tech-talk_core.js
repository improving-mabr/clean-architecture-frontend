...
// ../../core/node_modules/rxjs/dist/esm5/internal/operators/refCount.js
function refCount() {
...
// ../../core/node_modules/rxjs/dist/esm5/internal/observable/ConnectableObservable.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/scheduler/performanceTimestampProvider.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/scheduler/animationFrameProvider.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/observable/dom/animationFrames.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/BehaviorSubject.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/ReplaySubject.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/AsyncSubject.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/util/Immediate.js
var nextHandle = 1;
var resolved;
var activeHandles = {};
...
// ../../core/node_modules/rxjs/dist/esm5/internal/scheduler/immediateProvider.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/scheduler/AsapAction.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/scheduler/AsapScheduler.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/scheduler/asap.js
var asapScheduler = new AsapScheduler(AsapAction);

// ../../core/node_modules/rxjs/dist/esm5/internal/scheduler/async.js
var asyncScheduler = new AsyncScheduler(AsyncAction);

// ../../core/node_modules/rxjs/dist/esm5/internal/scheduler/QueueAction.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/scheduler/QueueScheduler.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/scheduler/queue.js
var queueScheduler = new QueueScheduler(QueueAction);

// ../../core/node_modules/rxjs/dist/esm5/internal/scheduler/AnimationFrameAction.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/scheduler/AnimationFrameScheduler.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/scheduler/animationFrame.js
var animationFrameScheduler = new AnimationFrameScheduler(AnimationFrameAction);

// ../../core/node_modules/rxjs/dist/esm5/internal/scheduler/VirtualTimeScheduler.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/observable/throwError.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/Notification.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/util/ArgumentOutOfRangeError.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/util/NotFoundError.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/util/SequenceError.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/operators/timeout.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/observable/never.js
var NEVER = new Observable(noop);

// ../../core/node_modules/rxjs/dist/esm5/internal/util/argsOrArgArray.js
var isArray3 = Array.isArray;

// ../../core/node_modules/rxjs/dist/esm5/internal/operators/distinctUntilChanged.js
...
var Store = class {
   ...
   */
  constructor(initialState3) {
    this.state$ = new BehaviorSubject(initialState3);
  }
  /**
   ...
   */
  select(filter2) {
    return this.state$.asObservable().pipe(map(filter2), distinctUntilChanged());
  }
  /**
   ...
   */
  get(filter2) {
    return filter2(this.state$.getValue());
  }
  /**
   ...
   */
  update(reduce2) {
    this.state$.next(reduce2(this.state$.getValue()));
  }
};

// ../../core/dist/post/application/state/IPostState.js
var initialState = {
  collection: {
    data: [],
    status: "idle"
...
// ../../core/dist/post/application/state/PostStore.js
var PostStore = class {
  /**
   *
   */
   ...
   *
   */
  collection$ = this.store.select((state) => state.collection);
  /**
   *
   * @param data
   */
  ...
  setCollectionStatus(status) {
    this.store.update((state) => __spreadProps(__spreadValues({}, state), {
      collection: __spreadProps(__spreadValues({}, state.collection), {
        status
      })
    }));
  }
   ...
   * @param subscription
   */
  setCollectionSubscription(subscription) {
...
// ../../core/dist/post/application/usecases/GetPostsByUserIdUseCase.js
var GetPostsByUserIdUseCase = class {
  repository;
  store;
  /**
   *
  ...
  execute(payload) {
    ...
    const subscription = this.repository.getPostsByUserId(payload).subscribe({
      next: (response) => {
        this.store.setCollectionData(response);
      },
      error: () => {
        this.store.setCollectionStatus("rejected");
      }
    });
...
// ../../core/dist/common/mapper.js
var Mapper = class {
};

// ../../core/dist/post/domain/mappers/PostMapper.js
var PostMapper = class extends Mapper {
  /***
   *
   * @param dto
   */
...
// ../../core/node_modules/rxjs/dist/esm5/internal/ajax/getXHRResponse.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/ajax/AjaxResponse.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/ajax/errors.js
...
// ../../core/node_modules/rxjs/dist/esm5/internal/ajax/ajax.js
...
// ../../core/dist/post/infrastructure/api/PostApi.js
var BASE_URL = "https://jsonplaceholder.typicode.com";
var fetchPostsByUser = (userId) => new Observable((sub) => {
  ajax.getJSON(`${BASE_URL}/users/${userId}/posts`).subscribe({
    next: (data) => {
      sub.next(data);
      sub.complete();
    },
...
// ../../core/dist/post/infrastructure/repositories/PostRepository.js
var PostRepository = class {
  ...
  getPostsByUserId(userId) {
    return fetchPostsByUser(userId).pipe(map((response) => response.map(this.mapper.mapFrom)));
  }
};

// ../../core/dist/user/application/state/IUserState.js
var initialState2 = {
  collection: {
    data: [],
    status: "idle"
...
// ../../core/dist/user/application/state/UserStore.js
var UserStore = class {
  /**
   *
   */
  store = new Store(initialState2);
  /**
   *
   */
  collectionSubscription;
   ...
   *
   */
  details$ = this.store.select((state) => state.details);
  /**
   *
   * @param data
   */
  setCollectionData(data) {
    const status = data.length > 0 ? "succeeded" : "empty";
    this.store.update((state) => __spreadProps(__spreadValues({}, state), {
      collection: {
        data,
        status
  ...
  setDetailsStatus(status) {
    this.store.update((state) => __spreadProps(__spreadValues({}, state), {
      details: __spreadProps(__spreadValues({}, state.details), {
        status
      })
    }));
  }
...
// ../../core/dist/user/application/usecases/GetUsersListUseCase.js
var GetUsersListUseCase = class {
  repository;
  store;
  /**
   *
  ...
  execute(payload) {
    this.store.setCollectionStatus("pending");
    const subscription = this.repository.getUsersList(payload).subscribe({
      next: (response) => {
        this.store.setCollectionData(response);
      },
      error: () => {
...
// ../../core/dist/user/domain/mappers/UserMapper.js
var UserMapper = class extends Mapper {
  /***
   *
   * @param dto
   */
...
// ../../core/dist/user/infrastructure/api/UserApi.js
var BASE_URL2 = "https://jsonplaceholder.typicode.com";
var fetchUsers = new Observable((sub) => {
  ajax.getJSON(`${BASE_URL2}/users`).subscribe({
    next: (data) => {
      sub.next(data);
      sub.complete();
    },
...
// ../../core/dist/user/infrastructure/repositories/UserRepository.js
var UserRepository = class {
   ...
   */
  getUsersList(paging) {
    return fetchUsers.pipe(map((response) => response.map(this.mapper.mapFrom)));
  }
};
export {
...
//# sourceMappingURL=@tech-talk_core.js.map
